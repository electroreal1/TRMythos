...
public class Mythos {
    ...
    public void editTOMLFile() {
        ...
        String[] newSkills = new String[]{"trmythos:omniscient_eye", "trmythos:faker", "trmythos:purity","trmythos:bloodsucker","trmythos:child_of_the_plane","trmythos:crimson_tyrant"};
