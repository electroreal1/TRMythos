...
public class VampireArchduke extends Race implements Transformation {
    ...
    public @Nullable Race getDefaultEvolution(Player player) {
        return (Race) TensuraRaces.RACE_REGISTRY.get().getValue(MythosSecretRaces.VAMPIRE_PRINCE);
    }
    ...
    public List<Race> getNextEvolutions(Player player) {
        ...
        return (List<Race>) TensuraRaces.RACE_REGISTRY.get().getValue(MythosSecretRaces.VAMPIRE_PRINCE);
    }
