...
public class VampireViscount extends Race implements Transformation {
    ...
    @Override
        ...
        public @Nullable Race getDefaultEvolution(Player player) {
            return (Race) TensuraRaces.RACE_REGISTRY.get().getValue(MythosSecretRaces.VAMPIRE_EARL);
        }
        ...
        public List<Race> getNextEvolutions(Player player) {
            ...
            return (List<Race>) TensuraRaces.RACE_REGISTRY.get().getValue(MythosSecretRaces.VAMPIRE_EARL);
        }
