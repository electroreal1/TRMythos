...
public class CarnageHandler {
    ...
    public static void onLivingDeath(LivingDeathEvent event) {
        ...
        if (attackerStorage == null || attackerStorage.getSkill(Skills.CARNAGE.get()).isEmpty()) return;

        // --- Track kill streak ---
        int streak = player.getPersistentData().getInt("CarnageKillStreak") + 1;
        player.getPersistentData().putInt("CarnageKillStreak", streak);
...
//        }
        ...
        String skillTag = "Carnage_SkillMsg_" + killedId;
