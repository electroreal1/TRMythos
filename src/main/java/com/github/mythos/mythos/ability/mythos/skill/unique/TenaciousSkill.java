...
public class TenaciousSkill extends Skill {
    public TenaciousSkill(SkillType type) {
    ...
    public void onTick(ManasSkillInstance instance, @NotNull LivingEntity entity) {
        ...
        TensuraPlayerCapability.getFrom(player).ifPresent(cap -> {
            ...
            double regenMPPerTick = (maxMP * 0.0001) / 20;
            double regenAPPerTick = (maxAP * 0.0001) / 20;
                ...
                if (!entity.isAlive()) {
                    if (source.getEntity() != null) {
                        ...
                        TensuraEPCapability.getFrom(entity).ifPresent((cap) -> {
                            ...
                            if (cap.getSpiritualHealth() < SHP * 0.10) {
                                cap.setSpiritualHealth(SHP * 0.10);
                            }
